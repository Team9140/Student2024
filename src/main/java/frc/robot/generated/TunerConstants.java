...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
            ...
            .withKS(0.18939).withKV(1.5).withKA(0);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
            .withKP(0.1128).withKI(0).withKD(0)
            .withKS(0.18181).withKV(0.12223).withKA(0.0022597);
    ...
    private static final double kSlipCurrentA = 30;
    ...
    private static final String kCANbusName = "moe";
    ...
    private static final double kFrontLeftEncoderOffset = -0.465576171875;
    private static final boolean kFrontLeftSteerInvert = true;

    private static final double kFrontLeftXPosInches = 11.375;
    private static final double kFrontLeftYPosInches = 7.875;
    ...
    private static final double kBackRightEncoderOffset = -0.02197265625;
    private static final boolean kBackRightSteerInvert = true;

    private static final double kBackRightXPosInches = -11.375;
    private static final double kBackRightYPosInches = -7.875;
